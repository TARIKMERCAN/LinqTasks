...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            var defaultRecord = new[] { new { Ename = "Brak wartości", Job = (string)null, HireDate = (DateTime?)null } };
            var empRecords = Emps.Select(e => new { Ename = e.Ename, Job = e.Job, HireDate = e.HireDate });
            return empRecords.Union(defaultRecord);
        }
        ...
        public static IEnumerable<object> Task11()
        {
            return Emps.GroupBy(e => e.Deptno)
                ...
                .Select(g => new { name = Depts.FirstOrDefault(d => 
                        d.Deptno == g.Key.Value)?.Dname.ToUpper(), 
        ...
        public static IEnumerable<Dept> Task14()
        {
            ...
            return Depts.Where(d => deptCounts.Any(dc => dc.Deptno == d.Deptno && (dc.Count == 5 || dc.Count == 0)))
                .OrderBy(d => d.Dname);
        }
        ...
        ///     ORDER BY COUNT(*) DESC;
        /// </summary>
        public static IEnumerable<Dept> Task15()//!!!!!NOT DONE
        {
        ...
        /// </summary>
        public static IEnumerable<Dept> Task16()//!!!!!NOT DONE
        {
            IEnumerable<Dept> result = null;
            //result =
            return result;
    ...
    public static class CustomExtensionMethods
    {
        ...
        {
            return emps.Where(manager => emps.Any(subordinate => subordinate.Mgr != null && subordinate.Mgr.Empno == manager.Empno))
                .OrderBy(e => e.Ename)
